 ...
 * @date 2022-04-24
 */
public class BizBaseGtnType extends BaseDTO
{
   ...
   // @Excel(name = "Status")
    ...
    public void setGtnTypeName(String gtnTypeName)
    {
        this.gtnTypeName = gtnTypeName;
    }

    public String getGtnTypeName()
    {
        return gtnTypeName;
    }
