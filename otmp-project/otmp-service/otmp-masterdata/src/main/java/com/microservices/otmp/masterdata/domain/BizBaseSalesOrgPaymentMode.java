...
/**
 * BaseSalesOrgPaymentMode对象 biz_base_sales_org_payment_mode
 * 
 * @author lovefamily
 * @date 2022-04-24
 */
public class BizBaseSalesOrgPaymentMode extends BaseDTO
{
   ...
   // @Excel(name = "Digits")
    ...
    {
        if(StringUtils.isNotBlank(paymentModeCode)){
            this.paymentModeCode = paymentModeCode.trim();
        }
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("paymentModeCode", getPaymentModeCode())
            .append("integrateMode", getIntegrateMode())
