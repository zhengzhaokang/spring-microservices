...
public class KafkaConsumerConfig {
    ...
    @Bean(KafkaFactory.BANK_INVOICE_SUBMISSION_FACTORY)
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> kafkaBankInvoiceSubmissionListenerContainerFactory() {
        return kafkaConsumerYmlConfig.getConsumerFactory(kafkaConsumerYmlConfig, KafkaFactory.BANK_INVOICE_SUBMISSION_FACTORY);
    }
}
