...
public interface SysUserDataScopeMapper {
    ...
    public List<SysUserDataScopeDO> selectDataScopeByUserId(Integer userId);
     ...
     * @return 列信息
     */
    public List<GenTableColumnDO> selectDbTableColumnsByName(@Param("tableName") String tableName,
                                                             @Param("tableCatalogs") String[] tableCatalogs,
                                                             @Param("tableSchemas") String[] tableSchemas);
}
