...
import com.microservices.otmp.system.resolver.LoginUserHandlerResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private static final String[] authInterceptorWhiteList = {"/login", "/login/slide", "/logininfor/save","/user/register", "/system/v2/api-docs",
            ...
            "/operLog/save", "/user/supplier/*","kafkaLog/save", "/user/getUserById/*","/microservices/id/*","/user/anchor/*"};
