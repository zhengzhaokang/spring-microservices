package com.microservices.otmp.system.aspect;
...
public class DataScopeAspect {
     ...
     */
    public static final String DATA_SYS_USER_DATA_SCOPE = "6";
    ...
    // 配置织入点
    @Pointcut("@annotation(com.microservices.otmp.common.annotation.DataScope)")
    public void dataScopePointCut() {
        log.info("DataScopePointCut In.");
    }
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias) {
        ...
        for (SysRole role : user.getRoles()) {
            ...
            } else if (DATA_SYS_USER_DATA_SCOPE.equals(dataScope) && user != null) {

                sqlString.append(StringUtils.format(" SELECT find_sys_user_scope_data({}) ", user.getUserId()));

            }
        }
        if (org.apache.commons.lang3.StringUtils.isNotBlank(sqlString.toString())) {
            BaseDTO baseEntity = (BaseDTO) joinPoint.getArgs()[0];
