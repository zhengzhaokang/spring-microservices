...
public interface SysUserMapper
{
    ...
    /**
     * 根据用户查询相同GEO的用户列表
     * @param queryParams 用户信息
     * @return 用户信息集合信息
     */
    public List<SysUser> selectUserListByCommonGeos(@Param("queryParams") Map<String, Object> queryParams);
    ...
    List<UserExportRoleVO> exportMenu(@Param("roleIds") List<Long> roleIds);
}
