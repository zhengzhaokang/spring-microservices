...
public class SysUser extends BaseDTO {
    ...
    public Boolean getmicroservicesIdSwitch() {
        return microservicesIdSwitch;
    }

    public void setmicroservicesIdSwitch(Boolean microservicesIdSwitch) {
        this.microservicesIdSwitch = microservicesIdSwitch;
    }
