...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.microservices.otmp.common.redis.annotation.RedisCache)")
    public void redisCachePoint() throws UnsupportedOperationException {
    }

    @Pointcut("@annotation(com.microservices.otmp.common.redis.annotation.RedisEvict)")
